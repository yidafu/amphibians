package dev.yidafu.amphibians.ksp.platform.android.webview.typescript
...
import dev.yidafu.amphibians.ksp.platform.android.reactnative.typescript.RegistryClassName
import dev.yidafu.amphibians.ksp.platform.android.reactnative.typescript.TurboModuleClass
...
val ClassDescriptor.jsapiModuleName: String
    get() = moduleName + "JSAPI"
...
fun FunctionDescriptor.toTsFunction() =
    FunctionSpec
        ...
        .apply {
            ...
            addStatement(
                "return this.callNative(%S, ${List(arguments.size) { "%N" }.joinToString(",") })",
                name,
                *arguments.map { it.toTsTypeName() }.toTypedArray(),
            )
